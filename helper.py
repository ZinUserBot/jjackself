...
app = Client('Jack_self', api_hash='5f8a5bec702456bb18d818d16e12806d', api_id= 11640179,
             bot_token='7112834920:AAFTscrzNfopZUhVgGF0HDC6ytWxGfMH3CI')
...
my_users = [6311580121] # ایدی عددی مالک 
users = filters.user(my_users) 

my_owners = [6311580121] # ایدی عددی مالک 
